...
public class FlourishNitrogen implements SeachemProduct {
    ...
    public FlourishNitrogen() {
        ...
        mName = DoserApplication.getContext().getString(R.string.product_flourish_nitrogen);
        mComment = DoserApplication.getContext().getString(R.string.product_comment_flourish_nitrogen);
    }
