...
public class LiquidAlkalineBuffer implements SeachemProduct {
    ...
    public LiquidAlkalineBuffer() {
        ...
        mName = DoserApplication.getContext().getString(R.string.product_liquid_alkaline_buffer);
        mComment = DoserApplication.getContext().getString(R.string.product_comment_liquid_alkaline_buffer);
    }
