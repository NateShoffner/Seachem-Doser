...
public class ReefStrontium implements SeachemProduct {
    ...
    public ReefStrontium() {
        ...
        mName = DoserApplication.getContext().getString(R.string.product_reef_strontium);
        mComment = DoserApplication.getContext().getString(R.string.product_comment_reef_strontium);
    }
