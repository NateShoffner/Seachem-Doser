...
public class ReefStrontium extends SeachemProduct {
    ...
    public ReefStrontium() {
        super(DoserApplication.getContext().getString(R.string.product_reef_strontium), DoserApplication.getContext().getString(R.string.product_comment_reef_strontium));
