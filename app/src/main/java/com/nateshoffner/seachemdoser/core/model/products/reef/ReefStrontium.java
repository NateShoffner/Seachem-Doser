...
public class ReefStrontium implements SeachemProduct {
    ...
    public ReefStrontium() {
        ...
        this.name = DoserApplication.getContext().getString(R.string.product_reef_strontium);
        this.comment = DoserApplication.getContext().getString(R.string.product_comment_reef_strontium);
    }
