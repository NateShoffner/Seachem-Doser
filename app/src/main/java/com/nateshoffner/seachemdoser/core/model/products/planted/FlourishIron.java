...
public class FlourishIron implements SeachemProduct {
    ...
    public FlourishIron() {
        ...
        mName = DoserApplication.getContext().getString(R.string.product_flourish_iron);
        mComment = DoserApplication.getContext().getString(R.string.product_comment_flourish_iron);
    }
