...
public class ReefBuilder implements SeachemProduct {
    ...
    public ReefBuilder() {
        ...
        mName = DoserApplication.getContext().getString(R.string.product_reef_builder);
        mComment = DoserApplication.getContext().getString(R.string.product_comment_reef_builder);
    }
