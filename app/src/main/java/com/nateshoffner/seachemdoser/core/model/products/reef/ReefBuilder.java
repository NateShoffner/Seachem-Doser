...
public class ReefBuilder extends SeachemProduct {

    public ReefBuilder() {
        super(DoserApplication.getContext().getString(R.string.product_reef_builder), DoserApplication.getContext().getString(R.string.product_comment_reef_builder));
    ...
    public SeachemDosage[] calculateDosage(UnitMeasurement unitMeasurement) {
        ...
        //todo official implementation suggests this may change in the future
        double grams = (0.32 * (volume * (desired - current)));
        double tspns = (grams / 6);
